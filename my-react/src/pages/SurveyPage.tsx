...
const SurveyPage: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [surveyRes, profileRes] = await Promise.all([
          ...
          axios.get<UserProfileData>("/profile/", {
            headers: { Authorization: `Bearer ${localStorage.getItem("access")}` },
          }),
        ]);

        setSurvey(surveyRes.data);
        setEditableSurvey(surveyRes.data);
  ...
  const handlePhotoUpload = async (file: File) => {
    try {
      ...
      setEditableSurvey(updatedSurvey);
    } catch (error) {
      ...
      <div className="flex justify-center mt-10">
        {loading ? (
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-white mt-2">Завантаження анкети...</p>
          </div>
        ) : (
            ...
            {!isEditing ? (
              ...
              <>
                ...
                <button
                  ...
                  className="bg-blue-500 text-white px-4 py-2 mt-4 w-full rounded hover:bg-blue-600 transition flex justify-center items-center"
                >
